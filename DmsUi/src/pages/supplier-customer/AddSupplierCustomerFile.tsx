  ...
  return (
    <div style={{ background: "#f3f4f6", minHeight: "100vh" }}>
      ...
      <main style={{ padding: "24px 32px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", background: "#fff", borderRadius: 8, border: "1px solid #e5e7eb", padding: "20px 24px" }}>
...
const primaryButton: React.CSSProperties = { background: "#0ea5e9", color: "#fff", border: "none", borderRadius: 16, padding: "8px 24px", fontSize: 13, fontWeight: 600, cursor: "pointer", transition: "all 0.15s" };
