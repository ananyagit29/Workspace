    ...
    <div style={{ background: "#f3f4f6", minHeight: "100vh" }}>
      ...
      <main style={{ padding: "24px 32px" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", background: "#fff", borderRadius: 8, border: "1px solid #e5e7eb", padding: "20px 24px" }}>
          <h2 style={{ fontSize: 11, fontWeight: 600, color: "#5f7a98", textTransform: "uppercase", letterSpacing: "0.05em", margin: "0 0 20px 0" }}>ADD SUPPLIER AND CUSTOMER FILES</h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ width: "100%" }}>
              <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: "#5f7a98", marginBottom: 8, textTransform: "uppercase" }}>Upload File</label>
              <div style={{ fontSize: 12, color: "#5f7a98", marginBottom: 12 }}>
